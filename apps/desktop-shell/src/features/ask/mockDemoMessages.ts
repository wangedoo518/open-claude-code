// S0.3 extraction: mock demo data for the Ask page's "View demo
// conversation" button. Verbatim copy of
// features/session-workbench/mockDemoMessages.ts with only the types
// import rewritten to the new shared location.
